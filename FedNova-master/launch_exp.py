...
rank = int(sys.argv[-1])
os.system(f"""python3 train_non_iid_50.py --pattern constant \
    --lr 0.02 --bs 32 --localE 2 --alpha 0.1 --mu 0 --momentum 0.9 \
    --save -p --name FedNova_momen_baseline --optimizer fednova --model ResNet \
    --rank {rank} --size 16 --backend nccl \
    --rounds 100 --seed 3 --NIID --print_freq 50""")